...
},{"./emptyFunction":31}],42:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":29,"fbjs/lib/warning":30,"./lib/ReactPropTypesSecret":42}],14:[function(require,module,exports) {
...
},{"object-assign":27,"fbjs/lib/invariant":29,"fbjs/lib/emptyObject":28,"fbjs/lib/warning":30,"fbjs/lib/emptyFunction":31,"prop-types/checkPropTypes":26}],9:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":14}],32:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":53}],35:[function(require,module,exports) {
'use strict';
...
},{"./camelize":45}],15:[function(require,module,exports) {
/** @license React v16.4.0
...
},{"fbjs/lib/invariant":29,"react":9,"fbjs/lib/warning":30,"fbjs/lib/ExecutionEnvironment":32,"object-assign":27,"fbjs/lib/emptyFunction":31,"prop-types/checkPropTypes":26,"fbjs/lib/getActiveElement":33,"fbjs/lib/shallowEqual":34,"fbjs/lib/containsNode":35,"fbjs/lib/emptyObject":28,"fbjs/lib/hyphenateStyleName":36,"fbjs/lib/camelizeStyleName":37}],11:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":15}],38:[function(require,module,exports) {
/*!
...
},{"isobject":38}],21:[function(require,module,exports) {
var define;
/*
 *          __        ___
 *    _____/ /___  __/ (_)____
...
},{"fbjs/lib/emptyFunction":31,"fbjs/lib/invariant":29,"fbjs/lib/warning":30,"object-assign":27,"./lib/ReactPropTypesSecret":42,"./checkPropTypes":26}],16:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":24}],23:[function(require,module,exports) {
/**
...
},{"is-plain-object":22,"stylis":21,"stylis-rule-sheet":20,"react":9,"prop-types":16,"hoist-non-react-statics":23}],39:[function(require,module,exports) {
...
},{"./_freeGlobal":65}],61:[function(require,module,exports) {
...
},{"./_root":64}],62:[function(require,module,exports) {
...
},{"./_Symbol":61}],63:[function(require,module,exports) {
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./_Symbol":61,"./_getRawTag":62,"./_objectToString":63}],51:[function(require,module,exports) {
/**
...
},{"./_baseGetTag":59,"./isObject":51}],55:[function(require,module,exports) {
...
},{"./isFunction":54,"./isLength":55}],50:[function(require,module,exports) {
/** Used as references for various `Number` constants. */
var MAX_SAFE_INTEGER = 9007199254740991;
...
},{"./eq":48,"./isArrayLike":49,"./_isIndex":50,"./isObject":51}],60:[function(require,module,exports) {
/**
...
},{"./_baseGetTag":59,"./isObjectLike":60}],52:[function(require,module,exports) {
var isObject = require('./isObject'),
...
},{"./isObject":51,"./isSymbol":56}],41:[function(require,module,exports) {
...
},{"./toNumber":52}],25:[function(require,module,exports) {
...
},{"./_baseRange":39,"./_isIterateeCall":40,"./toFinite":41}],18:[function(require,module,exports) {
...
},{"./_createRange":25}],58:[function(require,module,exports) {
'use strict';
...
var Waveform = _styledComponents2.default.canvas(_templateObject);

exports.default = Waveform;
},{"styled-components":10}],47:[function(require,module,exports) {
'use strict';
...
},{"./Waveform":58}],13:[function(require,module,exports) {
"use strict";
...
var powerOf2 = function powerOf2(props, propName, componentName) {
  var prop = props[propName];
  if (prop == null) return null;
  return Math.sqrt(prop) % 1 === 0 ? null : new Error("[PropTypes] Prop " + propName + " must be a power of 2");
};

powerOf2.isRequired = function (props, propName, componentName) {
  var prop = props[propName];
  return Math.sqrt(prop) % 1 === 0 ? null : new Error("[PropTypes] Prop " + propName + " must be a power of 2");
};
...
var Ticker = function Ticker() {
  ...
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$pauseInBackgroun = _ref.pauseInBackground,
      pauseInBackground = _ref$pauseInBackgroun === undefined ? true : _ref$pauseInBackgroun,
  ...
  this.start = function () {
    _this.paused = false;
    _this.tick(window.performance.now());
  };

  this.tick = function (t) {
    var tick = _this.tick,
        startTimes = _this.startTimes,
        times = _this.times,
        queue = _this.queue,
        paused = _this.paused,
        measureTasks = _this.measureTasks,
        mutateTasks = _this.mutateTasks;

    _this.lastTime = _this.lastTime || t;
    var delta = t - _this.lastTime;
    if (queue.length === 0) {
      _this.ticking = false;
      return;
    }
    ...
    while (i >= 0) {
      ...
      if (component.animationPaused || paused) {
        ...
        measureTasks[i] = fastdom.measure(component.update.bind(component, times[i]));
        mutateTasks[i] = fastdom.mutate(component.draw.bind(component, times[i]));
      }
      i--;
    }
  ...
  this.push = function (component) {
    var queue = _this.queue,
        tick = _this.tick;

    queue.push(component);
    if (_this.ticking || !_this.autostart) {
      return;
    }
  ...
  this.clear = function (component) {
    ...
    var idx = queue.indexOf(component);
    queue.splice(idx, 1);
    times.splice(idx, 1);
    fastdom.clear(measureTasks[idx]);
    fastdom.clear(mutateTasks[idx]);
  ...
  if (!pauseInBackground) {
    window.document.addEventListener('visibilitychange', function () {
      _this.pause(window.document.hidden);
    });
  }
};
...
var Analyzer = function (_Component) {
		_inherits(Analyzer, _Component);
		...
		_createClass(Analyzer, [{
				...
				value: function componentDidMount() {
						var _props = this.props,
						    audioContext = _props.audioContext,
						...
						_ticker2.default.push(this, false);
				}
		}, {
				key: 'update',
				value: function update(t) {
						...
						var fft = this.state.fft;

						this.analyzer.getFloatFrequencyData(fft);
						this.setState({ fft: fft });
				}
		}, {
				key: 'draw',
				...
				value: function render() {
						var _props3 = this.props,
						    ...
						    waveform = _props3.waveform;
						var _state = this.state,
						    timeDomain = _state.timeDomain,
						    fft = _state.fft;

						return _react2.default.createElement(this.props.visualizer, {
								bins: bins,
								waveform: waveform,
								progress: progress,
...
Analyzer.propTypes = {
		bins: _PropTypes.powerOf2.isRequired,
		visualizer: _propTypes2.default.func.isRequired,
		...
		waveform: _propTypes2.default.arrayOf(_propTypes2.default.number).isRequired,
		audioContext: _propTypes2.default.instanceOf(AudioContext),
		audio: _propTypes2.default.instanceOf(Audio)
};
exports.default = Analyzer;
},{"react":9,"prop-types":16,"./PropTypes":13,"ticker":17}],6:[function(require,module,exports) {
'use strict';
...
var Viz = _styled.Waveform.extend(_templateObject);
...
var Visualizer = function (_Component) {
  ...
  function Visualizer(props) {
    ...
    _this.draw = function () {
      if (_this.canvas == null) return;
      var _this$props = _this.props,
          waveform = _this$props.waveform,
          fft = _this$props.fft;

      var barHeightScalar = 1000;
      var barWidth = 10;
      var vCenter = 500;

      _this.ctx.clearRect(0, 0, _this.canvas.width, _this.canvas.width);
      ...
      for (var i = 0; i < waveform.length; i++) {
        ...
        _this.ctx.fillStyle = 'rgb(' + Math.floor(intensity * 255) + ', ' + Math.floor(intensity * 180) + ', ' + Math.floor(1 / intensity * 128) + ')';
        barHeight = waveform[i] * intensity * barHeightScalar * 2;
        barY = vCenter - barHeight / 2;
        _this.ctx.fillRect(i * barWidth, barY, barWidth, barHeight);
      }
    };
  ...
  _createClass(Visualizer, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          waveform = _props.waveform,
          progress = _props.progress,
          fft = _props.fft;

      if (waveform == null || fft == null) return null;

      return _react2.default.createElement(Viz, {
        innerRef: function innerRef(el) {
          if (el == null) return;
          _this2.canvas = el;
          _this2.ctx = el && el.getContext('2d');
        },
...
Visualizer.propTypes = {
  waveform: _propTypes2.default.arrayOf(Number).isRequired,
  fft: _propTypes2.default.instanceOf(Float32Array).isRequired,
  progress: _propTypes2.default.number.isRequired
};
exports.default = Visualizer;
},{"react":9,"prop-types":16,"lodash/range":18,"../PropTypes":13,"../styled":47}],57:[function(require,module,exports) {
'use strict';
...
exports.default = function (_ref) {
  var _ref$className = _ref.className,
      className = _ref$className === undefined ? 'icon-play' : _ref$className,
      props = _objectWithoutProperties(_ref, ['className']);

  return _react2.default.createElement(
    'svg',
    _extends({ className: className }, props, { xmlns: 'http://www.w3.org/2000/svg', width: '24', height: '24', viewBox: '0 0 24 24' }),
    _react2.default.createElement('path', { d: 'M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-3 17v-10l9 5.146-9 4.854z' })
  );
};
},{"react":9}],46:[function(require,module,exports) {
'use strict';
...
},{"./play":57}],4:[function(require,module,exports) {
'use strict';
...
var _Bars = require('./visualizers/Bars');
...
var Screen = _styled.Waveform.withComponent('div').extend(_templateObject);

_ticker2.default.autostart = false;
_ticker2.default.pauseInBackground = false;

var AudioContext = window.AudioContext || window.webkitAudioContext;

var AudioPlay = function (_Component) {
  _inherits(AudioPlay, _Component);

  function AudioPlay(props) {
    _classCallCheck(this, AudioPlay);

    var _this = _possibleConstructorReturn(this, (AudioPlay.__proto__ || Object.getPrototypeOf(AudioPlay)).call(this, props));
    ...
    _this.state = {
      bars: (0, _range2.default)(0, bins).map(function (b) {
        return 0;
      }),
      ready: false,
      cursor: 0,
  ...
  _createClass(AudioPlay, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          bins = _props2.bins,
          visualizer = _props2.visualizer;
      var _state = this.state,
          bars = _state.bars,
          ready = _state.ready,
          cursor = _state.cursor,
          shouldShowCursor = _state.shouldShowCursor,
          playingProgress = _state.playingProgress,
          playing = _state.playing,
          ended = _state.ended;

      var className = ready ? 'waveform--bar ready' : 'waveform--bar';
      var playheadX = Math.round(bins * playingProgress);
      ...
      return _react2.default.createElement(
        ...
        ready && source ? _react2.default.createElement(_Analyzer2.default, {
          bins: bins,
          audio: audio,
        ...
        _react2.default.createElement(_styled.Waveform, {
          innerRef: function innerRef(el) {
            _this2.canvas = el && el.getContext('2d');
          },
        ...
        _react2.default.createElement(
          'div',
          { className: 'controls' },
          _react2.default.createElement(_icons.Play, { className: 'controls--play', onClick: this.handlePressPlay })
        )
      );
    }
  }]);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleMetaData = function (d) {
    _this3.duration = _this3.audio.duration;
  };

  this.decodeAudio = function (blob) {
    var fileReader = new FileReader();
    fileReader.addEventListener('load', function () {
      _this3.audioContext.decodeAudioData(fileReader.result, _this3.calculateWaveform);
    });
    fileReader.readAsArrayBuffer(blob);
  };

  this.handlePressPlay = function (e) {
    var playing = _this3.state.playing;

    if (playing) {
      console.log('pausing');
      return _this3.setState({ playing: false }, function () {
        _ticker2.default.pause();
        _this3.audio.pause();
      });
    }
    return _this3.setState({ playing: true }, function () {
      if (_this3.state.ended) {
        console.log('restarting');
        _this3.setState({ playingProgress: 0, ended: false });
        _ticker2.default.push(_this3);
      } else {
        console.log('playing');
      }
  ...
  this.handleEnded = function (e) {
    _ticker2.default.clear(_this3);
    _this3.setState({ playing: false, ended: true, playingProgress: 0 });
  };

  this.update = function (e) {
    if (!_this3.state.playing) return;
    if (e / 1000 > _this3.duration) _this3.handleEnded();
    var bins = _this3.props.bins;

    var p = e / (1000 * _this3.duration);
    var f = Math.round(bins * p);
    _this3.setState({ playingProgress: p });
  };

  this.draw = function () {};

  this.calculateWaveform = function (buffer) {
    var bins = _this3.props.bins;

    var channels = (0, _range2.default)(0, buffer.numberOfChannels - 1).map(function (c) {
      return buffer.getChannelData(c);
    });
    var channelLength = channels[0].length;
    var windowLength = Math.floor(channelLength / bins);
    var averages = [];
    var base = Math.floor(channelLength / bins);
    var i = 0;
    var sum = 0;
    var rms = 0;
    ...
    while (i < channelLength) {
      ...
      sum += channels.reduce(function (m, c) {
        m += Math.pow(c[i], 2);
        return m;
      }, 0);
    ...
    _this3.setState({ bars: averages, ready: true }, _this3.renderWaveform);
  };

  this.renderWaveform = function () {
    if (_this3.canvas == null || _this3.screen == null) return;
    ...
    for (var i = 0; i < bars.length; i++) {
      ...
      barY = vCenter - barHeight / 2;
      _this3.canvas.fillRect(i * barWidth, barY, barWidth, barHeight);
    }
  };
};
...
AudioPlay.propTypes = {
  ...
  bins: _PropTypes.powerOf2.isRequired,
  visualizer: _propTypes2.default.func
};

AudioPlay.defaultProps = {
  bins: 256,
  visualizer: _Bars2.default
};

exports.default = AudioPlay;
},{"react":9,"prop-types":16,"styled-components":10,"lodash/range":18,"./styled":47,"./Analyzer":12,"./visualizers/Bars":6,"./icons":46,"ticker":17,"./PropTypes":13}],5:[function(require,module,exports) {
module.exports="/lavender.bffd09cf.mp3";
...
var BANDWIDTH = 20000 - 20;
var MAX_HARMONIC = 3000 / BANDWIDTH;
var PITCH_DICT = (0, _range2.default)(0, 11).map(function (i) {
...
var Visualizer = function (_Component) {
  ...
  function Visualizer(props) {
    ...
    _this.draw = function () {
      if (_this.canvas == null) return;
      var spectrum = _this.props.spectrum;

      var binWidth = 10;
      var vCenter = 500;
      var widthHeightRatio = _this.canvas.width / _this.canvas.height;
      ...
      for (var i = 0; i < _this.bins; i++) {
        intensity = (spectrum[i] + 280) / 280;
        circleR = intensity * vCenter / 2;
        _this.ctx.strokeStyle = 'rgb(' + Math.floor(intensity * 255) + ', ' + Math.floor(intensity * 180) + ', ' + Math.floor(1 / intensity * 128) + ')';
        _this.ctx.beginPath();
        _this.ctx.ellipse(i * binWidth, vCenter, circleR * widthHeightRatio, circleR, 0, 0, 2 * Math.PI);
        _this.ctx.stroke();
        _this.ctx.closePath();
      }
    };

    _this.bins = props.waveform.length;
    return _this;
  }
...
Visualizer.propTypes = {
  waveform: _propTypes2.default.arrayOf(Number).isRequired,
  spectrum: _PropTypes.float32Array,
  progress: _propTypes2.default.number.isRequired
};
},{"react":9,"prop-types":16,"lodash/range":18,"../PropTypes":13,"../styled":47}],2:[function(require,module,exports) {
'use strict';
...
var _AudioPlay = require('./AudioPlay');

var _AudioPlay2 = _interopRequireDefault(_AudioPlay);

var _lavender = require('./audio/lavender.mp3');

var _lavender2 = _interopRequireDefault(_lavender);

var _Bars = require('./visualizers/Bars');

var _Bars2 = _interopRequireDefault(_Bars);

var _Circles = require('./visualizers/Circles');
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        Wrap,
        null,
        _react2.default.createElement(_AudioPlay2.default, { src: _lavender2.default, visualizer: _Bars2.default })
      );
    }
  }]);
...
},{"react":9,"react-dom":11,"styled-components":10,"./AudioPlay":4,"./audio/lavender.mp3":5,"./visualizers/Bars":6,"./visualizers/Circles":7}],66:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.a6601a1a.map